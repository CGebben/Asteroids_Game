/*
 * Alien Logic Disabled while debugging core game loop.
 ...
 * int Y = 0;
 * 
 * // The size of the Alien (default is 4, possibly indicating difficulty or
 * hitbox
 * // size).
 * private int size = 4;
 * 
 ...
 * super(new Polygon(130, 50, 110, 80, 0, 80, -20, 50, 20, 50, 30, 30, 80, 30,
 * 90, 50), x, y);
 ...
 * }
 * 
 * /// Moves the Alien along a predefined looping path using a Timeline
 * animation.
 ...
 * 
 * 
 * alien_bullets.forEach(Bullet::move);
